...
import Controle.Forno.AlterarFornoCtrl;
 ...
 * @author Cristiano GD
 */
public class AlterarForno extends javax.swing.JFrame {

    private String id;
    /**
     * Creates new form AlterarForno
     */
    public AlterarForno(String id_forno, String nome_forno, String situacao_forno, int upc_forno, int volume_maximo_forno) {
        initComponents();
        this.id = id_forno;
        jTextFieldNomeForno.setText(nome_forno);
        //jTextFieldSituacaoForno.setText(situacao_forno);
        jSpinnerVol_Max.setValue(volume_maximo_forno);
        jSpinnerUPC.setValue(upc_forno);
    ...
    private void AlterarDados(){
        DateFormat data_alteracao_forno = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        Date date = new Date();

        ControleForno forno = new ControleForno();
        forno.setId_forno(id);
        forno.setNome_forno(jTextFieldNomeForno.getText().toString());
        forno.setSituacao_forno(jComboBoxSituacao.getSelectedItem().toString());
        forno.setVolume_maximo_forno((int)jSpinnerVol_Max.getValue());
        forno.setUpc_forno((int)jSpinnerUPC.getValue());
        forno.setData_alteracao(data_alteracao_forno.format(date));
        forno.setUsuario_alt(ControlePrincipal.id_op);
        
        //SELECT * FROM notas WHERE id_notas >= 0 limit 10
        
        AlterarFornoCtrl alterar = new AlterarFornoCtrl(forno);
    ...
    private void initComponents() {
        ...
        jButtonAtualizar.setPreferredSize(new java.awt.Dimension(100, 60));
        ...
        jSpinnerUPC.setModel(new javax.swing.SpinnerNumberModel(0, 0, 500, 1));
        jSpinnerUPC.setPreferredSize(new java.awt.Dimension(200, 25));

        jComboBoxSituacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione a situação", "Aberto", "Manutenção", "Reforma" }));
        jComboBoxSituacao.setPreferredSize(new java.awt.Dimension(200, 25));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jButtonAtualizar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarForno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AlterarForno().setVisible(true);
        });
    }
